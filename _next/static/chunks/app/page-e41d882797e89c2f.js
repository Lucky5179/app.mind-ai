    ...
    98140: function (e, t, a) {
          ...
          return (0, n.jsx)("header", {
            ...
            children: (0, n.jsxs)("div", {
              ...
              children: [
                ...
                (0, n.jsx)("div", { className: "menu-fader" }),
              ],
            }),
          });
        },
                    ...
                    children: [
                      (0, n.jsxs)("ul", {
                        children: [
                          (0, n.jsx)("li", {
                            children: (0, n.jsx)("a", {
                              href: "https://etherscan.io/token/0x599A6f6dadf67b1736C24432154d5b8Eb175E507#code",
                              target: "_blank",
                              children: "Contract",
                            }),
                          }),
      ...
      let d = (e) => {
        ...
        return (0, n.jsxs)("div", {
          ...
          children: [
              ...
              children: [
                (0, n.jsx)("li", {
                  children: (0, n.jsxs)("a", {
                    ...
                    href: "https://app.uniswap.org/swap?outputCurrency=0x599A6f6dadf67b1736C24432154d5b8Eb175E507",
                    target: "_blank",
                    children: [
                      (0, n.jsx)("span", { children: "Uniswap" }),
                      (0, n.jsx)("span", { "data-text": "Uniswap" }),
                      (0, n.jsx)("img", {
                        src: "/assets/img/trades/uniswap.svg",
                        alt: "",
                      }),
                    ],
                  }),
            ...
            (0, n.jsx)("div", { onClick: a, className: "close" }),
          ],
        });
      };
      var o = a(21040),
        c = a(48796),
        p = a(76039);
      let u = "0x599A6f6dadf67b1736C24432154d5b8Eb175E507",
      ...
      let w = null,
        ...
        b = async () => {
          ...
          if ((await e.request({ method: "eth_accounts" })).length > 0)
            return (
              (f = new h.Q(e)), (w = await f.getSigner()), await w.getAddress()
            );
          try {
            return (
              (await e.request({ method: "eth_chainId" })) !== "0x1" &&
                (await e.request({
        ...
        T = async () => {
          let e = await N();
          return new p.CH("0x599A6f6dadf67b1736C24432154d5b8Eb175E507", x.M, e);
        };
      var A = a(99232);
      let S = (e) => parseFloat(A.dF(e)).toFixed(0),
        C = (e, t, a) =>
          Number.isNaN(e) || Number.isNaN(t)
            ? "0"
            : ((((t * e) / 100) * a * 86400) / 31536e3).toFixed(2),
        ...
        I = (e, t, a, n, s) =>
          e <= t
            ...
            : e >= a
            ? s.toFixed(0)
            : (n + ((s - n) * (e - t)) / (a - t)).toFixed(0),
        E = (e) => {
          let t = Math.floor(e / 30),
            a = e % 30;
          return t > 0
            ? a > 0
              ? "".concat(t, " months and ").concat(a, " days")
              : "".concat(t, " months")
            : "".concat(e, " days");
        },
        M = async (e) => {
      ...
      let H = (e) =>
        ...
        q = (e) => {
          ...
          return t > 0
            ? "".concat(t, " day").concat(1 !== t ? "s" : "")
            : a > 0
            ? "".concat(a, " hour").concat(1 !== a ? "s" : "")
            : n > 0
            ? "".concat(n, " minute").concat(1 !== n ? "s" : "")
            : "".concat(e, " second").concat(1 !== e ? "s" : "");
        };
      var J = a(68842);
      let K = (0, i.createContext)({
          ...
          flexibleStakeInfo: { flexibleApy: 0 },
          userFlexibleInfo: {
            lastUpdate: "0",
            totalRewards: "0",
            totalStaked: "0",
        ...
        $ = (e) => {
          let { children: t } = e,
            ...
            [u, y] = (0, i.useState)({ flexibleApy: 0 }),
            [m, x] = (0, i.useState)([]),
            [h, w] = (0, i.useState)(!1),
            { open: f } = (0, J.k_)(),
            { walletProvider: v } = (0, J.B0)(),
            { address: N, chainId: k, isConnected: T } = (0, J.Zc)(),
            { disconnect: A } = (0, J.qL)(),
            C = async (e) => {
              try {
                if ("metamask" === e) {
      ...
      var ee = a(20703),
        et = (e) => {
          let { connectWallet: t, setShowConnectWalletModal: a } = e;
          return (0, n.jsx)("div", {
            className:
              "fixed text-white top-0 left-0 w-screen h-screen bg-[#040718]/90 z-10 flex justify-center items-center",
            onClick: () => a(!1),
            children: (0, n.jsxs)("div", {
              className:
                "rounded-3xl w-full max-w-[416px] bg-[#050F2D] px-4 walletPop py-8 border border-solid border-gray-700 ml-2 mr-2",
              onClick: (e) => {
                e.stopPropagation();
              },
              children: [
                  ...
                  children: [
                    ...
                    (0, n.jsxs)("div", {
                      ...
                      children: [
                        (0, n.jsxs)("div", {
                          className:
                            "flex flex-row hover:opacity-75 items-center rounded-2xl justify-between gap-2 cursor-pointer px-4 py-5 bg-[#171A22]",
                          onClick: () => {
                            t("metamask"), a(!1);
                          },
                          children: [
                            (0, n.jsx)("span", { children: "Metamask" }),
                            (0, n.jsx)("img", {
                        ...
                        (0, n.jsxs)("div", {
                          className:
                            "flex items-center hover:opacity-75 justify-between gap-2 rounded-2xl cursor-pointer px-4 py-5 bg-[#171A22]",
                          onClick: () => {
                            t("walletconnect"), a(!1);
                          },
                          children: [
                            (0, n.jsx)("span", { children: "WalletConnect" }),
                            (0, n.jsx)("img", {
      ...
      let en = (e) => {
        ...
        (0, i.useEffect)(() => {
          ...
          let e = () => {
              x(window.scrollY > 0),
                document.querySelectorAll(".js_detect-scroll").forEach((e) => {
                  window.scrollY + window.innerHeight - 100 >
                    e.getBoundingClientRect().top + window.scrollY &&
                    e.classList.add("visible");
                }),
                document
                  .querySelectorAll(".js_scroll-progress")
                  .forEach((e) => {
                    let t =
                      (window.scrollY +
                        window.innerHeight -
                    ...
                    e.setAttribute(
                      "style",
                      "--percent: ".concat(t <= 0 ? 0 : t > 0 && t < 1 ? t : 1)
                    );
                  });
            },
            t = () => {
        ...
        let v = async (e) => {
            try {
              ...
              (0, ea.yv)(e.message, { variant: "error" });
            }
          },
          N = async () => {
            try {
        ...
        return (0, n.jsxs)("div", {
          ...
          children: [
            ...
            s &&
              (0, n.jsxs)("div", {
                className:
                  "bg-slate-800 p-3 flex justify-between w-full items-center text-stone-300",
                children: [
                  (0, n.jsxs)("div", {
                    className: "flex items-center gap-2",
                    children: [
                      (0, n.jsx)(c.SVk, { color: "yellow", size: 20 }),
                      (0, n.jsxs)("p", {
                        className: "text-base",
                        children: [
                          "Confirm you are at",
                  ...
                  (0, n.jsx)("div", {
                    ...
                    onClick: a,
                    children: (0, n.jsx)(o.ZCS, { size: 20 }),
                  }),
                ],
              }),
            (0, n.jsxs)("div", {
              ...
              children: [
                ...
                (0, n.jsx)(d, { isOpen: f, handleClose: () => b(!1) }),
              ],
            }),
          ],
        });
      ...
      let ei = () =>
        (0, n.jsxs)("div", {
          className:
            "pt-24 xl:pb-24 pb-16 flex justify-center flex-col space-y-4 items-center",
          children: [
            (0, n.jsxs)(es.E.div, {
              ...
              children: [
                ...
                (0, n.jsxs)("p", {
                  ...
                  children: [
                    "Grow the community with the Edenomyshlins.",
                    (0, n.jsx)("br", {}),
            ...
            (0, n.jsxs)(es.E.div, {
              className:
                "flex flex-row items-center justify-center space-x-4 pt-4",
      ...
      var er = a(6128),
                ...
                children: [
                  ...
                  "claim" === a.action
                    ? (0, n.jsx)("button", {
                        onClick: () => i(t),
                        className:
                          "py-1 px-6 inline-flex text-black items-center text-sm font-semibold rounded-full border border-transparent bg-emerald-300 hover:bg-emerald-400 disabled:opacity-50 disabled:pointer-events-none",
                        children:
                          l.index === t && l.status
                            ? (0, n.jsx)(el, {})
                            : "Claim",
                    ...
                    : (0, n.jsxs)("div", {
                        ...
                        children: [
                          (0, n.jsx)("button", {
                            onClick: () => s(t),
                            className:
                              "py-1 px-6 inline-flex text-red-600 items-center text-sm font-semibold rounded-full border border-transparent bg-zinc-800 hover:bg-zinc-700 disabled:opacity-50 disabled:pointer-events-none",
                            children:
                              r.index === t && r.status
                                ? (0, n.jsx)(el, {})
                                : "Withdraw",
                          ...
                          (0, n.jsx)("span", {
                            ...
                            children:
                              "Withdrawing now will forfeit your rewards",
                          }),
                        ],
                      }),
                ],
        ...
        eo = () => {
          let {
            ...
            [r, l] = (0, i.useState)(!1),
            [d, o] = (0, i.useState)({ status: !1, index: 0 }),
            [c, p] = (0, i.useState)({ status: !1, index: 0 }),
            u = async (e) => {
              o({ status: !0, index: e });
              try {
                let t = await D(e);
                (await t.wait()) &&
                  (await s(),
                  (0, ea.yv)("Successfully claimed", { variant: "success" }));
              } catch (t) {
                let e = t.message.split('(reason="');
                if (e && (null == e ? void 0 : e.length) > 1) {
                  let t = e[1].split('"')[0];
                  (0, ea.yv)(t, { variant: "error" });
                } else (0, ea.yv)("Couldn't claim!", { variant: "error" });
              }
              o({ status: !1, index: e });
            },
            m = async (e) => {
              ...
              try {
                ...
                (await t.wait()) &&
                  (await s(),
                  (0, ea.yv)("Successfully withdraw", { variant: "success" }));
              } catch (t) {
                let e = t.message.split('(reason="');
                if (e && (null == e ? void 0 : e.length) > 1) {
                  let t = e[1].split('"')[0];
                  (0, ea.yv)(t, { variant: "error" });
                } else (0, ea.yv)("Couldn't withdraw!", { variant: "error" });
              }
              p({ status: !1, index: e });
            },
            x = async (e) => {
          ...
          return (0, n.jsxs)(n.Fragment, {
            children: [
              ...
              (0, n.jsxs)(es.E.div, {
                className:
                  "rounded-[40px] border border-solid xl:space-y-8 space-y-4 md:w-[500px] border-gray-600 p-12 flex flex-col bg-[#000000] ml-2 mr-2",
                ...
                children: [
                  (0, n.jsxs)("div", {
                    className:
                      "flex flex-row items-center space-x-6 justify-between",
                    children: [
                      (0, n.jsx)("p", {
                      ...
                      e &&
                        (0, n.jsx)("div", {
                          className:
                            "rounded-full cursor-pointer uppercase text-white text-xl font-semibold px-5 py-3 bg-gray-800 hover:bg-gray-800",
                          onClick: () =>
                            e &&
                            window.open(
                              "".concat(y, "/address/").concat(e),
                              "_blank",
                              "noopener,noreferrer"
                            ),
                          children: (0, n.jsxs)("div", {
                  ...
                  !e &&
                    (0, n.jsx)("button", {
                      className:
                        "rounded-full py-4 bg-white text-black w-full text-center hover:opacity-75",
                      onClick: () => l(!0),
        ...
        ep = {
          ...
          width: 24,
          blurDataURL:
            "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAICAYAAADED76LAAAAeklEQVR42pWNwQ2DQAwEL4muAa/hRVtUkke6CA/sRKkhUrCdAmgN6YQ4CV7Ma+3RatMeuF7rdZS3LU8lV8jGXERIB9M7np9LbYa2MO35LwSXgSfpyt/WOY5Xw64Kkwf/lFZZJ8jfGS4zuwpce3wlpz0UQ+YYG7i06QwLMzQntERkUF0AAAAASUVORK5CYII=",
          blurWidth: 8,
          blurHeight: 8,
        },
        eu = (e) => {
            ...
            a = (0, i.useMemo)(
              () =>
                "string" == typeof t.amount
                  ...
                  ? S(t.amount.toFixed(0))
                  : 0,
              [t.amount]
            ),
            s = new Date(t.date).toLocaleDateString("en-US", {
              weekday: "short",
              day: "numeric",
              year: "numeric",
            });
              ...
              (0, n.jsxs)("div", {
                ...
                children: [
                  (0, n.jsx)("div", {
                    ...
                    children: (0, n.jsx)(ee.default, {
                      src:
                        "StakedFixed" === t.name || "Staked" === t.name
                          ? ec
                          : ep,
                      width: 24,
                      height: 24,
                  ...
                  (0, n.jsxs)("div", {
                    ...
                    children: [
                      (0, n.jsx)("p", {
                        ...
                        children:
                          "RewardClaimedFixed" === t.name ? "Claimed" : t.name,
                      }),
                      (0, n.jsx)("p", {
        ...
        ey = (e) => {
          let { setSelectedTab: t } = e,
            { walletAddress: a, balance: s } = Z(),
            [r, l] = (0, i.useState)(!1),
          ...
          return (
            (0, i.useEffect)(() => {
              (async () => {
                try {
                  ...
                  (0, ea.yv)("Couldn't fetch history", { variant: "error" });
                }
                p(!1);
              })();
            }, [a]),
            (0, n.jsxs)("div", {
              ...
              children: [
                (0, n.jsx)("div", {
                  className:
                    "flex flex-col border border-solid rounded-[40px] border-gray-300",
                  children: (0, n.jsxs)("div", {
                    className:
                      "rounded-t-[40px] flex flex-col space-y-8 py-8 blenderBg",
                    children: [
                      (0, n.jsxs)("div", {
                        className:
                      ...
                      (0, n.jsxs)("div", {
                        className:
                          "flex justify-center flex-col items-center space-y-1",
                        children: [
                          (0, n.jsx)("p", {
                            className: "opacity-50",
                ...
                (0, n.jsxs)("div", {
                  className:
                    "rounded-[40px] border border-solid border-gray-600 py-12 px-16 flex flex-col space-y-6",
                  children: [
                    (0, n.jsx)("p", {
                    ...
                    d &&
                      ...
                      (0, n.jsx)("div", {
                        ...
                        children: (0, n.jsx)("button", {
                          className:
                            "text-center rounded-full px-6 py-2 bg-gray-900 hover:opacity-75 text-white",
                          onClick: () => {
                            l(!0);
                          },
                          children: "Load more",
      ...
      let ex = i.forwardRef((e, t) => {
        ...
        return (0, n.jsxs)(em.fC, {
          ...
          children: [
            ...
            (0, n.jsx)(em.bU, {
              className:
                "block h-4 w-4 rounded-full border border-white/50 bg-white cursor-pointer shadow transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
            }),
          ],
        });
      });
      ...
      var eh = (e) => {
        let { setSelectedTab: t } = e,
          ...
          g = (0, i.useMemo)(() => C(parseInt(b), parseFloat(c), w), [b, c, w]),
          j = async (e) => {
            try {
              await l(e);
            } catch (e) {
          ...
          v = async () => {
            (0, ea.yv)(
              "Staking is currently disabled. You can still unstake your tokens as usual",
              { variant: "warning" }
            );
          };
        return (0, n.jsxs)(n.Fragment, {
          children: [
            ...
            (0, n.jsxs)(es.E.div, {
              className:
                "rounded-[40px] border border-solid xl:space-y-8 space-y-4 md:w-[500px] border-gray-600 flex flex-col bg-gradient-to-r from-blue-900 to-blue-500 ml-2 mr-2",
              initial: { opacity: 0, y: "-20%" },
              whileInView: { opacity: 1, y: "0" },
              transition: { duration: 0.5, delay: 0 },
              viewport: { once: !0 },
              children: [
                  ...
                  children: [
                    (0, n.jsxs)("div", {
                      ...
                      children: [
                        (0, n.jsx)("div", {
                          className:
                            "rounded-full uppercase text-white text-xl font-semibold px-5 py-3 bg-gray-800 hover:bg-gray-800 ".concat(
                              s && "cursor-pointer"
                            ),
                          onClick: () =>
                            s &&
                            window.open(
                              "".concat(y, "/address/").concat(s),
                              "_blank",
                              "noopener,noreferrer"
                            ),
                          children: (0, n.jsxs)("p", {
                    ...
                    (0, n.jsxs)("div", {
                      className:
                        "flex justify-center flex-col items-center space-y-1 mt-10",
                      children: [
                        (0, n.jsx)("p", {
                          className: "opacity-50",
                          children: "Available to stake",
                ...
                (0, n.jsxs)("div", {
                  className:
                    "rounded-[40px] border-t border-solid border-gray-600 p-12 flex flex-col bg-[#000000] space-y-4",
                  children: [
                    (0, n.jsxs)("div", {
                      className:
                        "bg-black rounded-b-[40px] flex flex-row items-start justify-between",
                      children: [
                        (0, n.jsxs)("div", {
                    ...
                    (0, n.jsxs)("div", {
                      className:
                        "flex flex-row items-center space-x-6 justify-center pt-10",
                      children: [
                        (0, n.jsx)("p", {
                        ...
                        (0, n.jsx)("div", {
                          className:
                            "rounded-full cursor-pointer uppercase text-white text-xl font-semibold px-5 py-3 bg-gray-900 hover:bg-gray-800",
                          onClick: () => {
                            p(r.toString());
                          },
                          children: "MAX",
                    ...
                    (0, n.jsx)("div", {
                      ...
                      children: (0, n.jsx)("input", {
                        ...
                        className:
                          "text-white text-6xl placeholder:text-4xl text-center !bg-transparent outline-none !border-none md:max-w-sm w-full",
                      }),
                    }),
                    !s &&
                      (0, n.jsx)("button", {
                    ...
                    (0, n.jsxs)("div", {
                      className:
                        "flex flex-row justify-between items-start space-x-12",
                      children: [
                        (0, n.jsxs)("div", {
                          className:
                            "flex flex-col space-y-2 md:text-sm text-xs text-white opacity-60 text-left",
                          children: [
                            (0, n.jsx)("p", { children: "Your address" }),
                            (0, n.jsx)("p", { children: "Staking Amount" }),
                            (0, n.jsx)("p", {
                              className: "pb-8",
                              children: "Staking Reward",
                            }),
                            (0, n.jsx)("p", { children: "Total Balance" }),
                            (0, n.jsx)("p", { children: "Average Return" }),
                          ],
                        }),
                        (0, n.jsxs)("div", {
                          className:
                            "flex flex-col space-y-2 md:text-sm text-xs text-white justify-end items-end",
                          children: [
                            (0, n.jsx)("p", {
      ...
      let ew = (e) => {
        let { selectedTab: t, setSelectedTab: a } = e;
        return (0, n.jsxs)("div", {
          className:
            "rounded-[50px] bg-[#24263A] border-1 border-solid flex p-2 flex-row items-center space-x-2",
          children: [
            (0, n.jsx)("div", {
              className:
                "rounded-[40px] justify-center flex flex-1 w-full cursor-pointer text-white text-center py-4 text-[14px] ".concat(
                  "stake" === t
                    ? "bg-[#6C95C0] text-white hover:opacity-75"
            ...
            (0, n.jsx)("div", {
              className:
                'rounded-[40px] flex flex-1 w-full justify-center cursor-pointer text-white text-center py-4 text-[14px] hover:opacity-75  selectedTab === "unstake"\n    '.concat(
                  "unstake" === t
                    ? "bg-[#6C95C0] text-white hover:opacity-75"
                    : "bg-gray-700 text-white hover:opacity-75",
                  "\n}"
                ),
              onClick: () => a("unstake"),
              children: "Unstake",
      ...
      var ef = () => {
          ...
          return (0, n.jsxs)("div", {
            className:
              "md:pt-12 md:pb-16 pb-12 flex flex-col space-y-8 text-center",
            children: [
              (0, n.jsxs)(es.E.div, {
                initial: { opacity: 0, y: "-30%" },
                whileInView: { opacity: 1, y: "0" },
              ...
              (0, n.jsx)(es.E.div, {
                ...
                children:
                  "history" !== e &&
                  (0, n.jsx)(ew, { selectedTab: e, setSelectedTab: t }),
              }),
              "stake" === e && (0, n.jsx)(eh, { setSelectedTab: t }),
              "unstake" === e && (0, n.jsx)(eo, {}),
              "history" === e && (0, n.jsx)(ey, { setSelectedTab: t }),
            ],
          });
        },
        eb = () =>
          (0, n.jsxs)("div", {
            className:
              "flex flex-col items-center h-auto min-h-screen w-full stake-bg text-white",
      ...
      function ev() {
        return (0, n.jsx)($, {
          children: (0, n.jsx)(ej, {
            children: (0, n.jsx)(en, { children: (0, n.jsx)(eb, {}) }),
          }),
        });
      }
      (0, J.OY)({
        ...
        chains: [
          {
            ...
            rpcUrl:
              "https://mainnet.infura.io/v3/a0b74d65173042fabe9639289bd336b5",
          },
        ],
